// �뚢��������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������� \\
// �� Rapha챘l 2.2.0 - JavaScript Vector Library                                                             �� \\
// �쒋��������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������� \\
// �� Copyright 짤 2008-2016 Dmitry Baranovskiy (http://raphaeljs.com)                                       �� \\
// �� Copyright 짤 2008-2016 Sencha Labs (http://sencha.com)                                                 �� \\
// �쒋��������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������� \\
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// �뚢����������������������������������������������������������������������������������������������������������������������������������������� \\
	// �� Rapha챘l @@VERSION - JavaScript Vector Library                      �� \\
	// �쒋����������������������������������������������������������������������������������������������������������������������������������������� \\
	// �� Copyright 짤 2008-2012 Dmitry Baranovskiy (http://raphaeljs.com)    �� \\
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function(eve) {
	     ...
	     * Element.getTotalLength
	     [ method ]
	     **
	     * Returns length of the path in pixels. Only works for element of �쐏ath�� type.
	     = (number) length.
	    \*/
	     ...
	     * Element.getPointAtLength
	     [ method ]
	     **
	     * Return coordinates of the point located at the given length on the given path. Only works for element of �쐏ath�� type.
	     **
	     > Parameters
	     **
	     - length (number)
	     ...
	     * Element.getPath
	     [ method ]
	     **
	     * Returns path of the element. Only works for elements of �쐏ath�� type and simple elements like circle.
	     = (object) path
	     **
	    \*/
	     ...
	     * Element.getSubpath
	     [ method ]
	     **
	     * Return subpath of a given element from given length to given length. Only works for element of �쐏ath�� type.
	     **
	     > Parameters
	     **
	     - from (number) position of the start of the segment
	     ...
	     * Object that contains easing formulas for animation. You could extend it with your own. By default it has following list of easing:
	     # <ul>
	     #     <li>�쐋inear��</li>
	     #     <li>��&lt;�� or �쐃aseIn�� or �쐃ase-in��</li>
	     #     <li>��>�� or �쐃aseOut�� or �쐃ase-out��</li>
	     #     <li>��&lt;>�� or �쐃aseInOut�� or �쐃ase-in-out��</li>
	     ...
	     * Set.isPointInside
	     [ method ]
	     **
	     * Determine if given point is inside this set�셲 elements
	     **
	     > Parameters
	     **
	     - x (number) x coordinate of the point
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function(R) {
	    ...
	    Element = function (node, svg) {
	         ...
	         * Element.paper
	         [ property (object) ]
	         **
	         * Internal reference to �쐏aper�� where object drawn. Mainly for use in plugins and element extensions.
	         > Usage
	     ...
	     * If cx & cy aren�셳 specified centre of the shape is used as a point of rotation.
	     = (object) @Element
	    \*/
	     ...
	     * If cx & cy aren�셳 specified centre of the shape is used instead.
	     = (object) @Element
	    \*/
	     ...
	     * i.e. translation doesn�셳 change `x` or `y` of the rectange. The format
	     * of transformation string is similar to the path string syntax:
	     | "t100,100r30,100,100s2,2,100,100r45s1.5"
	     * Each letter is a command. There are four commands: `t` is for translate, `r` is for rotate, `s` is for
	     * scale and `m` is for matrix.
	     *
	     * There are also alternative �쏿bsolute�� translation, rotation and scale: `T`, `R` and `S`. They will not take previous transformation into account. For example, `...T100,0` will always move element 100 px horisontally, while `...t100,0` could move it vertically if there is `r90` before. Just compare results of `r90t100,0` and `r90T100,0`.
	     *
	     * So, the example line above could be read like �쐔ranslate by 100, 100; rotate 30째 around 100, 100; scale twice around 100, 100;
	     * rotate 45째 around centre; scale 1.5 times relative to centre��. As you can see rotate and scale commands have origin
	     * coordinates as optional parameters, the default is the centre point of the element.
	     * Matrix accepts six parameters.
	     > Usage
	     | var el = paper.rect(10, 20, 300, 200);
	     | // translate 100, 100, rotate 45째, translate -100, 0
	     ...
	     * Sets the attributes of the element.
	     > Parameters
	     - attrName (string) attribute�셲 name
	     - value (string) value
	     * or
	     ...
	     * or
	     ...
	     o stroke-dasharray (string) [�쒋��, �쐍one��, ��`-`��, ��`.`��, ��`-.`��, ��`-..`��, ��`. `��, ��`- `��, ��`--`��, ��`- .`��, ��`--.`��, ��`--..`��]
	     ...
	     o y (number)
	     > Gradients
	     * Linear gradient format: ��`�퉍ngle��-�퉏olour��[-�퉏olour��[:�퉛ffset��]]*-�퉏olour��`��, example: ��`90-#fff-#000`�� �� 90째
	     * gradient from white to black or ��`0-#fff-#f00:20-#000`�� �� 0째 gradient from white via red (at 20%) to black.
	     *
	     * radial gradient: ��`r[(�퉒x��, �퉒y��)]�퉏olour��[-�퉏olour��[:�퉛ffset��]]*-�퉏olour��`��, example: ��`r#fff-#000`�� ��
	     * gradient from white to black or ��`r(0.25, 0.75)#fff-#000`�� �� gradient from white to black with focus point
	     * at 0.25, 0.75. Focus point coordinates are in 0..1 range. Radial gradients can only be applied to circles and ellipses.
	     > Path String
	     # <p>Please refer to <a href="http://www.w3.org/TR/SVG/paths.html#PathData" title="Details of a path�셲 data attribute�셲 format are described in the SVG specification.">SVG documentation regarding path string</a>. Rapha챘l fully supports it.</p>
	     > Colour Parsing
	     # <ul>
	     #     <li>Colour name (��<code>red</code>��, ��<code>green</code>��, ��<code>cornflowerblue</code>��, etc)</li>
	     #     <li>#�™�™�� �� shortened HTML colour: (��<code>#000</code>��, ��<code>#fc0</code>��, etc)</li>
	     ...
	     #     <li>Optionally for hsb and hsl you could specify hue as a degree: ��<code>hsl(240deg,&nbsp;1,&nbsp;.5)</code>�� or, if you want to go fancy, ��<code>hsl(240째,&nbsp;1,&nbsp;.5)</code>��</li>
	     # </ul>
	    \*/
	     ...
	     * Element.toFront
	     [ method ]
	     **
	     * Moves the element so it is the closest to the viewer�셲 eyes, on top of other elements.
	     = (object) @Element
	    \*/
	     ...
	     * Element.toBack
	     [ method ]
	     **
	     * Moves the element so it is the furthest from the viewer�셲 eyes, behind other elements.
	     = (object) @Element
	    \*/
